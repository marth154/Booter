...
$req = base()->prepare('SELECT * FROM utilisateur_jeux WHERE id_utilisateur = :id AND id_jeux = 6');
...
foreach($req as $req)
{
	?>
		...
		<div style="display:inline;">
			<div style=" border-top: 1px solid balck; margin: 15px -1px 0px 10px;">
				<a style="text-decoration: none; color: balck;  font-size: 20px;" href=<?="../traitement/traitement_profil.php?p=" . $req['id_utilisateur'];?>>
					<p>
...
<div class="container">
  <div class="heading">
    ...
    <div class="score-container" style="color:black;">0</div>
  </div>
...
<script>
function try_again(score)
{
	alert(score);
/*	$.ajax({
		type: 'GET',
		url: '../traitement/traitement_jeux.php?2048',
  ...
  var auto_refresh = setInterval(
	function ()
	{
	$('#score1').load('../script/meilleur_score_2048.php');
}, 3000);

  var auto_refresh = setInterval(
	function ()
	{
	$('#score2').load('../script/score_2048.php');
}, 1000);
